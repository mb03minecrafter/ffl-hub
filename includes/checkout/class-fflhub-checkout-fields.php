 ...
 * visibility via JSON Schema (WooCommerce 9.9+). :contentReference[oaicite:2]{index=2}
 */
class FFLHub_Checkout_Fields
{
     ...
     *
     * (You can change this to whatever naming scheme you like.)
     */
     ...
     * Checkout Block UI automatically. :contentReference[oaicite:3]{index=3}
     */
        ...
        woocommerce_register_additional_checkout_field(
            array(
                ...
                'required' => array(
                    ...
                    // See conditional examples using 'cart' in the docs. :contentReference[oaicite:4]{index=4}
                    'cart' => array(
                        'properties' => array(
                            'extensions' => array(
                                'properties' => array(
     ...
     *
     * Hook: woocommerce_set_additional_field_value (WC 8.9+). :contentReference[oaicite:5]{index=5}
     *
    ...
    public static function validate_receiving_ffl($value)
    {
        ...
        // If DB is not available, don't hard-fail checkout.
    ...
    private static function get_ffl_data_by_number(string $ffl_number): ?array
    {
        ...
        if (! class_exists('FFLHub_FFL_Importer')) {
            return null;
        }
