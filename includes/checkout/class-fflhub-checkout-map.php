    ...
    private static function cart_contains_ffl_required_item(): bool
    {
        ...
        foreach ($cart as $cart_item) {
            ...
            foreach (array($variation_id, $product_id) as $id) {
                ...
                // Use Woo CRUD meta access. Replace constant with your meta key string/constant.
                $ffl_required = $product->get_meta(FFLHub_Product_Meta::FFLHUB_FFL_REQUIRED_META, true);
