...
class FFLHub_RSR_Fulfillment_Table {
    ...
    public static function get_table_name_with_suffix( string $suffix ): string {
        global $wpdb;
        return $wpdb->prefix . FFLHub_RSR_Fulfillment_Schema::BASE_TABLE_KEY . '_' . $suffix;
    }
    ...
    public static function get_live_table_name(): string {
        ...
        $stored = get_option( FFLHub_RSR_Fulfillment_Schema::LIVE_TABLE_OPTION );
        if ( is_string( $stored ) && $stored !== '' ) {
            ...
            if ( $stored === 'v1' || $stored === 'v2' ) {
                ...
                update_option( FFLHub_RSR_Fulfillment_Schema::LIVE_TABLE_OPTION, $normalized );
                return $normalized;
            }
        }

        update_option( FFLHub_RSR_Fulfillment_Schema::LIVE_TABLE_OPTION, $default );
        return $default;
    }
    ...
    public static function swap_live_and_staging(): string {
        ...
        update_option( FFLHub_RSR_Fulfillment_Schema::LIVE_TABLE_OPTION, $current_stage );
    ...
    public static function create_tables(): void {
        ...
        $cols    = FFLHub_RSR_Fulfillment_Schema::get_column_definitions();
        $indexes = FFLHub_RSR_Fulfillment_Schema::get_index_definitions();
