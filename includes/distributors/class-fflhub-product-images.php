 ...
 *
 * Behavior:
 * - Uses ALL image URLs in FFLHub_Distributor_Product_Payload::$image_urls.
...
class FFLHub_Product_Images
{
     ...
     * @param string                             $upc
     * @param FFLHub_Distributor_Product_Payload $payload
    ...
    public static function import_primary_image_for_product(
        int $product_id,
        string $upc,
        FFLHub_Distributor_Product_Payload $payload,
    ...
    {
        // Adjust this to your existing logging strategy if needed.
