...
class FFLHub_Admin_Page
{
    ...
    public static function init(): void
    {
        ...
        add_action('admin_init', array(__CLASS__, 'register_global_settings'));
    }
    ...
    public static function register_menu_page(): void
    {
        add_menu_page(
            ...
            'manage_options',
            self::PAGE_SLUG,
            array(FFLHub_Plugin::instance(), 'render_settings_page'),
    ...
    public static function register_global_settings(): void
    {
        ...
        register_setting(
            ...
            array(
                'type'              => 'string',
                'sanitize_callback' => array(__CLASS__, 'sanitize_payment_processor_fee_percent'),
    ...
    /**
     * Entry point used by FFLHub_Plugin::render_settings_page().
     *
     * @param FFLHub_Distributor_Interface[] $distributors
     */
