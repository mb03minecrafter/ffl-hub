                ...
                <section class="fflhub-shipping-card">
                    <div class="fflhub-shipping-card-head">
                        <div>
                            ...
                            <p class="description">
                                <?php esc_html_e('Refresh after installing or signing into the PrintNode desktop client. The selected printer receives label/slip jobs from the WMS Sending page.', 'ffl-hub'); ?>
                            </p>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description"><?php esc_html_e('Seconds the continuous PrintNode worker waits between actual PrintNode submissions.', 'ffl-hub'); ?></p>
                                </td>
                            </tr>
                            <tr>
