                ...
                <div class="fflhub-receiving-step is-active" data-step="identify">
                    ...
                    <div class="fflhub-receiving-step-body">
                        ...
                        <label class="fflhub-receiving-debug-toggle">
                            ...
                            <span>
                                <strong><?php esc_html_e('Debug: include older and test shipments', 'ffl-hub'); ?></strong>
                                <?php esc_html_e('Use this for testing old boxes or dummy labels. Normal receiving includes completed Woo orders when their dealer-fulfilled job rows have tracking.', 'ffl-hub'); ?>
                            </span>
                        </label>
