            ...
            <table class="widefat striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php esc_html_e('When enabled for a distributor, a scheduled non-priority batch below that distributor\'s free-shipping threshold is moved to the next dispatch window instead of being submitted immediately. It keeps rolling until the threshold is met or an operator uses force flush.', 'ffl-hub'); ?></td>
                    </tr>
                </tbody>
            </table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <label>
                                    ...
                                    <?php esc_html_e('Hold until free shipping threshold is met or force flushed', 'ffl-hub'); ?>
                                </label>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                        ...
                        <?php if ($has_rows && $threshold > 0.0 && !$is_free) : ?>
                            <div style="margin-top:4px;color:#50575e;font-size:12px;">
                                ...
                                $rollover_text = !empty($group['rollover_enabled'])
                                    ? __('Rollover enabled: holds until threshold or force flush', 'ffl-hub')
