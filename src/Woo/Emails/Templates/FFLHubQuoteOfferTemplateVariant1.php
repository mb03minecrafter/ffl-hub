...
<p style="margin:0 0 14px;"><?php echo sprintf(esc_html__('For %1$s, your final price is %2$s %3$s.', 'ffl-hub'), esc_html($context->product_name), esc_html($context->final_price_display), esc_html($context->shipping_phrase)); ?></p>
